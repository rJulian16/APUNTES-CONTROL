...
📚Ejercicio 4: Otro eje lineal parte también desde el reposo y desde la posición \(0\), pero con una aceleración menor de \(1.5 \, \frac{m}{s^2}\). ¿Cuál es la posición alcanzada luego de \(5 \, s\) de movimiento?
